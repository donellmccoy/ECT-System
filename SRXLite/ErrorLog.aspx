<%@ Page Language="VB" AutoEventWireup="false" Inherits="SRXLite.Web.ErrorLog" Codebehind="ErrorLog.aspx.vb" %>
...
<body style="margin:10px">
    ...
    <div>
		...
		<asp:GridView ID="gvErrorLog" runat="server" EnableViewState="false" AutoGenerateColumns="false" AllowSorting="false" CellPadding="4" Width="100%">
			<Columns>
