...
{
    public class SARCAppealPostProcessing
    {
        public SARCAppealPostProcessing()
        {
        }

        public SARCAppealPostProcessing(int id)
        {
            this.appealId = id;
            this.AppealAddress = new Address();
        }

        public SARCAppealPostProcessing(int id, string helpExtensionNumber, Address appealAddress, DateTime? notificationDate, string email)
        {
            this.AppealAddress = new Address();
