...
Namespace Web.Special_Case.MH
    ...
    Partial Class Secure_sc_mh_NextAction
...
#End Region
        ...
        Public Sub SaveCancelData()
            ...
            SpecCase.CaseCancelExplanation = Server.HtmlEncode(CommentsTextBox.Text.Trim) '            If rblCancellation.SelectedValue <> "" Then
            If rblReason.SelectedValue <> "" Then
                SpecCase.CaseCancelReason = CShort(rblReason.SelectedValue) '                LOD.phy_cancel_reason = rblCancellation.SelectedValue
            End If
        ...
        Protected Function GetStatusInfo(ByVal statusCodeOut As Integer) As Tuple(Of Integer, String)
            ...
            Select Case statusCodeOut
                Case SpecCaseMHStatusCode.InitiateCase, SpecCaseMHStatusCode.FinalReview, SpecCaseMHStatusCode.Approved, SpecCaseMHStatusCode.Override, SpecCaseMHStatusCode.Holding
                    sentTo = "HQ Tech"
                    sentToId = UserGroups.AFRCHQTechnician
                Case SpecCaseMHStatusCode.MedicalReview
                    sentTo = "Board Medical"
                    sentToId = UserGroups.BoardMedical
                Case SpecCaseMHStatusCode.SeniorMedicalReview
...
#Region "ChangeStatusAndActions"
        ...
        Public Sub AddEmails(ByRef emails As MailManager, emailService As EmailService, action As WorkflowOptionAction, statusOut As Integer)
            ...
            If (statusOut = SpecCaseMHWorkStatus.Approved Or statusOut = SpecCaseMHWorkStatus.Disapproved) Then
        ...
        Public Sub ReturnBack(ByVal statusIn As Integer, ByVal statusOut As Integer, ByVal ReturnFlag As Boolean)
            ...
            If (rwRec IsNot Nothing AndAlso rwRec.DateSentBack Is Nothing) Then
                ...
                ElseIf (statusCodeOut = SpecCaseMHStatusCode.Cancelled) Then           'Case was canceled during Return
                    rwRec.DateSentBack = DateTime.Now
                ...
                ElseIf (statusCodeOut = SpecCaseMHStatusCode.Approved OrElse statusCodeOut = SpecCaseMHStatusCode.Disapproved) Then            'Case was completed during Return
                    rwRec.DateSentBack = DateTime.Now
                    If (String.IsNullOrEmpty(rwRec.CommentsBackToSender)) Then
