<%@ Page Language="VB" MasterPageFile="~/Secure/SARC_Appeal/SARC_Appeal.master" AutoEventWireup="false" Async="true" Inherits="ALOD.Web.APSA.Secure_apsa_SMData" Title="Untitled Page" Codebehind="SMData.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentNested" runat="Server">
    ...
    <asp:Panel runat="server" ID="pnlPostCompletion" CssClass="dataBlock" Visible="False">
        ...
        <div class="dataBlock-body">
            <table class="dataTable">
                ...
                <tr>
                    ...
                    <td class="value">
                        <asp:TextBox ID="NotificationDate" runat="server" MaxLength="10" onchange="DateCheck(this);" Width="80" CssClass="datePicker" Visible="false" />
        ...
        <uc1:SignatureCheck runat="server" ID="ucPostCompletionSigCheck" Template="Form348SARCAppealPostProcessing" CssClass="sigcheck-form no-border" />
    </asp:Panel>
    ...
    <uc1:SignatureCheck ID="SigCheck" runat="server" Template="Form348APSARC" CssClass="sigcheck-form" />
</asp:content>
