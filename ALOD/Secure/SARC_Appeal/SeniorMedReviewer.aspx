<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/SARC_Appeal/SARC_Appeal.master" AutoEventWireup="false" Inherits="ALOD.Web.APSA.SeniorMedReviewer" Codebehind="SeniorMedReviewer.aspx.vb" %>
        ...
        <ContentTemplate>
            <div class="dataBlock" id="SeniorMedical" runat="server">
                <div class="dataBlock-header">
                    Senior Medical Reviewer SARC Appeal Decision
                </div>
