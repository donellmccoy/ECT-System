...
Namespace Web.APSA
    ...
    Partial Class Secure_apsa_PostCompletionSARCAppeal
        ...
        Protected Sub AppealData_Selecting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceSelectingEventArgs) Handles AppealData.Selecting
            ...
            e.InputParameters("moduleId") = CByte(ModuleType.SARCAppeal)
            e.InputParameters("sarcpermission") = UserHasPermission("SARC")
