<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false" Inherits="ALOD.Web.APSA.Search" Codebehind="Search.aspx.vb" %>

<asp:Content runat="Server" ID="Content2" ContentPlaceHolderID="ContentFooter">
    ALOD.Web.APSA.Search
...
<%--                        <asp:TemplateField HeaderText="Print">
    ...
    <asp:ObjectDataSource ID="StatusData" runat="server" SelectMethod="GetWorkstatusByWorkflow" TypeName="ALOD.Data.Services.LookupService">
        <SelectParameters>
            <asp:Parameter DefaultValue="29" Name="workflow" Type="Byte" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="SearchData" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SARCAppealRequestSearch" TypeName="ALOD.Data.Services.LodService">
        <SelectParameters>
            ...
            <asp:Parameter DefaultValue="26" Name="moduleId" Type="Byte" />
