<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false"
    Async="true" Inherits="ALOD.Web.Special_Case.WWD.Secure_wwd_MyCases" Codebehind="MyCases.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentMain" runat="Server">
    ...
    <asp:UpdatePanel ID="resultsUpdatePanel" runat="server" ChildrenAsTriggers="True">
        <ContentTemplate>
            ...
            <div style="font-weight: bold">
                My Cases: <%= IIf(WorkflowDao.GetCaseType(9, 0).Contains("Worldwide Duty"), "Non Duty Disability Evaluation System (NDDES)", WorkflowDao.GetCaseType(9, 0)) %>
            </div>
            ...
            <div style="font-weight: bold">
                My Cases: <%= IIf(WorkflowDao.GetCaseType(9, 0).Contains("Worldwide Duty"), "Non Duty Disability Evaluation System (NDDES)", WorkflowDao.GetCaseType(9, 0))%> - Waiting on Disposition Response
            </div>
            ...
            <div style="font-weight: bold">
                My Cases: <%= IIf(WorkflowDao.GetCaseType(9, 0).Contains("Worldwide Duty"), "Non Duty Disability Evaluation System (NDDES)", WorkflowDao.GetCaseType(9, 0))%> - Holding
            </div>
    ...
    <asp:ObjectDataSource ID="SCData_Module9" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetSpecailCaseNoDisposition" 
