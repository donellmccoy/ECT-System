...
Namespace Web.Special_Case.PEPP
    ...
    Partial Class Secure_pepp_init
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            Dim userAccess As PageAccess.AccessLevel = SCDao.GetUserAccess(SESSION_USER_ID, refId, ModuleType.SpecCasePEPP)

            Utility.VerifyUserAccess(userAccess, Resources.Messages.ERROR_NO_ACCESS, Resources._Global.StartPage)

            Dim scPEPP As SC_PEPP = MasterPage.LoadCase(refId)

            Session("refId") = refId

            Utility.UpdateCaseLock(userAccess, refId, ModuleType.SpecCasePEPP)

            MasterPage.InitPageAccess(scPEPP)

            Dim startPage As String = MasterPage.GetStartPageTitle(scPEPP.Status)

            MasterPage.SetSubWorkflowType(scPEPP)
