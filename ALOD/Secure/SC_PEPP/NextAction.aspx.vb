...
Namespace Web.Special_Case.PEPP
    ...
    Partial Class Secure_sc_pepp_NextAction
        ...
        Private boardStages As Short() = New Short() {
            CShort(SpecCasePEPPStatusCode.InitiateCase),
            CShort(SpecCasePEPPStatusCode.MedicalReview),
            CShort(SpecCasePEPPStatusCode.SeniorMedicalReview),
            CShort(SpecCasePEPPStatusCode.FinalReview),
            CShort(SpecCasePEPPStatusCode.ExtAgencyDisposition)}

        Private CANCELLATION_REASON As String = "Case Cancelled By "
        Private errors As New List(Of ValidationItem)
        Private sc As SC_PEPP
        Private separatorTemplate As System.Web.UI.CompiledTemplateBuilder

        Private unitStages As Short() = New Short() {
            CShort(SpecCasePEPPStatusCode.RWOAHold)}

#Region "SC_PEPPProperty"
        ...
        Protected ReadOnly Property ModuleType() As ModuleType
            Get
                Return ModuleType.SpecCasePEPP
            End Get
        End Property
...
#End Region
        ...
        Protected Function GetStatusInfo(ByVal statusCodeOut As Integer) As Tuple(Of Integer, String)
            ...
            Select Case statusCodeOut
                Case SpecCasePEPPStatusCode.InitiateCase, SpecCasePEPPStatusCode.RWOAHold, SpecCasePEPPStatusCode.FinalReview, SpecCasePEPPStatusCode.ExtAgencyDisposition
                    sentTo = "HQ Tech"
                    sentToId = UserGroups.AFRCHQTechnician
                Case SpecCasePEPPStatusCode.MedicalReview
                    sentTo = "Board Medical"
                    sentToId = UserGroups.BoardMedical
                Case SpecCasePEPPStatusCode.SeniorMedicalReview
        ...
        Private Sub ShowRLB()
            Dim access As ALOD.Core.Domain.Workflow.PageAccessType = SectionList(PESectionNames.PE_RLB.ToString())
...
#Region "ChangeStatusAndActions"
        ...
        Public Sub AddEmails(ByRef emails As MailManager, emailService As EmailService, action As WorkflowOptionAction, statusOut As Integer)
            ...
            If (statusOut = SpecCasePEPPWorkStatus.Complete) Then
        ...
        Public Sub ReturnBack(ByVal statusIn As Integer, ByVal statusOut As Integer, ByVal ReturnFlag As Boolean)
            ...
            If (rwRec IsNot Nothing AndAlso rwRec.DateSentBack Is Nothing) Then
                ...
                ElseIf (statusCodeOut = SpecCasePEPPStatusCode.Cancelled) Then           'Case was canceled during Return
                    rwRec.DateSentBack = DateTime.Now
                ...
                ElseIf (statusCodeOut = SpecCasePEPPStatusCode.Complete) Then            'Case was completed during Return
