...
#Region "Fields..."
        ...
        Protected Const PAGE_TITLE As String = "SARC Admin"
        Protected Const REMARKS_MAX_LENGTH As Integer = 250
...
#Region "Page Methods..."
        ...
        Protected Sub InitiateControls()
            SetFindingsControlAccess(ucSARCAdminFindings, SectionList(SARCSectionNames.SARC_ADMIN.ToString()))
        End Sub
        ...
        Protected Sub SaveData()
            ...
            If (Not HasReadWriteAccessForSection(SARCSectionNames.SARC_ADMIN)) Then
                Exit Sub
            End If
            ...
            If (ucSARCAdminFindings.Remarks.Length > REMARKS_MAX_LENGTH) Then
                cFinding.Remarks = ucSARCAdminFindings.Remarks.Substring(0, REMARKS_MAX_LENGTH)
            Else
                cFinding.Remarks = ucSARCAdminFindings.Remarks
            End If
