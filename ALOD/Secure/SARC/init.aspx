<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Secure/SARC/SARCMaster.master" CodeBehind="init.aspx.vb" Inherits="ALOD.Web.SARC.Secure_SARC_init" %>

<%@ Reference Control="~/Secure/Shared/UserControls/TabNavigator.ascx" %>
<%@ Reference Control="~/Secure/Shared/UserControls/TabControls.ascx" %>
<%@ Reference Control="~/Secure/Shared/UserControls/ModuleHeader.ascx" %>
<%@ Reference Control="~/Secure/SARC/SARCMaster.master" %>
