...
Namespace Web.Special_Case.BCMR
    ...
    Partial Class Secure_sc_bc_MedTech
...
#End Region
        ...
        Private Sub InitControls()
            ...
            'Load Findings
            If SpecCase.med_tech_approved = 1 Then
                DecisionY.Checked = True
            End If
            If SpecCase.med_tech_approved = 0 Then
                DecisionN.Checked = True
            End If

            If Not IsNothing(SpecCase.med_tech_approved) Then
                DecisionComment.Text = Server.HtmlDecode(SpecCase.med_tech_approval_comment.ToString())
            End If
        ...
        Private Sub SaveFindings()
            ...
            PageAccess = SectionList(CISectionNames.CI_COMPLETE.ToString())

            If SpecCase.Status = SpecCaseCongressWorkStatus.Complete Then
                If DecisionN.Checked Then
                    SpecCase.med_tech_approved = 0
                End If
                If DecisionY.Checked Then
                    SpecCase.med_tech_approved = 1
                End If

                SpecCase.med_tech_approval_comment = Server.HtmlEncode(DecisionComment.Text)
