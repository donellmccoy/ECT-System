...
Namespace Web.Special_Case.RW
    ...
    Partial Class Secure_rw_MyCases
        ...
        Protected Sub gvResults11_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs) Handles gvResults11.RowCommand
            If (e.CommandName = "view") Then
                Dim parts() As String = e.CommandArgument.ToString().Split(";")
                ...
                Select Case args.Type
                    Case ModuleType
                        args.Url = "~/Secure/SC_RW/init.aspx?" + strQuery.ToString()
        ...
        Protected Sub SCData_Module11_Selecting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceSelectingEventArgs) Handles SCData_Module11.Selecting
            e.InputParameters("moduleId") = ModuleType
        End Sub
