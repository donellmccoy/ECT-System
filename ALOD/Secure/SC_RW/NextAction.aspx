<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/SC_RW/SC_RW.master" AutoEventWireup="false" Inherits="ALOD.Web.Special_Case.RW.Secure_sc_rw_NextAction" 
    MaintainScrollPositionOnPostback="true" EnableEventValidation="false" Codebehind="NextAction.aspx.vb" %>

<%@ Register Src="~/Secure/Shared/UserControls/ValidationResults.ascx" TagName="validationresults" TagPrefix="lod" %>
        ...
        <div class="dataBlock-body">
            ...
            <table>
                ...
                <tr id="commentsRow" runat="server" class="reasonRow" visible="false">
                    ...
                    <td id="Comments" class="label" runat="server">
