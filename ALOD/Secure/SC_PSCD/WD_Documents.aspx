<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/SC_PSCD/SC_PSCD.Master" AutoEventWireup="false" Inherits="ALOD.Web.Special_Case.PSCD.Secure_PSCD_WWD_Documents" MaintainScrollPositionOnPostback="true" CodeBehind="WD_Documents.aspx.vb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentNested" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <uc1:Documents runat="server" ID="ucWDDocuments" />
        </ContentTemplate>
    </asp:UpdatePanel>
...
<%--<asp:Content ID="Content2" ContentPlaceHolderID="ContentNested" runat="Server">
   ...
   <table class="docHeader">
        <tr>
            <td style="width: 650px;" title="Determination Memorandum">
            ...
            <td colspan="3" style="text-align: right; width: 300PX;">
                ...
                <asp:Image runat="server" ID="CreateMemo2" ImageAlign="AbsMiddle" ImageUrl="~/images/create_document.gif"
                    CssClass="iconUpload" AlternateText="Create New Memo" />&nbsp;&nbsp;
                <asp:Image runat="server" ID="CreateRTDMemo" ImageAlign="AbsMiddle" ImageUrl="~/images/create_document.gif"
                    CssClass="iconUpload" AlternateText="Create WWD Return to Duty Memo" 
                    ToolTip="Create RTD Memo" Visible="False" />
            </td>
        </tr>
    </table>
        <asp:Repeater runat="server" ID="MemoRepeater">
            <ItemTemplate>
                ...
                <tr class="docRow">
                    <td style="text-align: left; width: 475px;" title="Test1">
                        <asp:HyperLink runat="server" ID="ViewMemoLink" NavigateUrl="#">
                            ...
                            <asp:Label runat="server" Visible="false" ID="memoTitle" Text='<%#Server.HtmlEncode(Eval("Template.Title"))%>' />
                        </asp:HyperLink>
                    </td>
                    <td style="text-align: left; width: 275px;" title="Created Date">
                        <%#HTMLEncodeNulls(Eval("CreatedDate", "{0:" + DATE_FORMAT + "}"))%>.
                    </td>
                    <td style="text-align: right; width: 200px;" titlw="Test3">
