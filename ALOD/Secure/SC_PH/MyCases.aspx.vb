...
Namespace Web.Special_Case.PH
    ...
    Partial Class Secure_ph_MyCases
        ...
        Protected Sub gvResults11_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvResults11.RowDataBound
            ...
            Dim refId As Integer = Integer.Parse(CType(e.Row.FindControl("hdnRefId"), HiddenField).Value)
            ...
            'CType(e.Row.FindControl("lblUnitName"), Label).Text = sc.DPHUser.CurrentUnitName
        ...
        Protected Sub SCData_Module11_Selecting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceSelectingEventArgs) Handles SCData_Module23.Selecting
