<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false" Async="true" Inherits="ALOD.Web.Special_Case.PH.Secure_ph_MyCases" Codebehind="MyCases.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentMain" runat="Server">
    ...
    <asp:UpdatePanel ID="resultsUpdatePanel" runat="server" ChildrenAsTriggers="True">
        <ContentTemplate>
            ...
            <div style="font-weight:bold">My Cases: <%= WorkflowDao.GetCaseType(23, 0)%></div>
            <asp:GridView ID="gvResults11" runat="server" EmptyDataText="No records found" EmptyDataRowStyle-CssClass="emptyItem"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Case Id" SortExpression="Case_Id" ItemStyle-Width="150px">
                        <ItemTemplate>
                            <asp:HiddenField runat="server" ID="hdnRefId" Value='<%# Eval("SC_Id").ToString() %>' />
...
<%--                    <asp:TemplateField HeaderText="Name" ItemStyle-Width="200px" SortExpression="Member_Name">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lblDPHUserName" />
                        </ItemTemplate>
                        <ItemStyle Width="200px" />
                    </asp:TemplateField>--%>
                    <%--<asp:TemplateField HeaderText="Reporting Period">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lblReportingPeriod" />
                        </ItemTemplate>
                    </asp:TemplateField>--%>
            ...
            <div style="font-weight: bold">
                My Cases: <%= WorkflowDao.GetCaseType(23, 0)%> - Waiting on Disposition Response
            </div>
            ...
            <div style="font-weight: bold">
                My Cases: <%= WorkflowDao.GetCaseType(23, 0)%> - Holding
            </div>
