<%@ Page Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false" Inherits="ALOD.Web.Admin.Secure_Shared_Admin_TrainingData" Title="Untitled Page" Codebehind="TrainingData.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentMain" runat="Server">
    ...
    <br />
    <br />
    No Data?&nbsp; Generate SM info for the selected region:&nbsp;<asp:Button ID="btnGenerate"
        runat="server" Text="Go" /><br />
    <br />
