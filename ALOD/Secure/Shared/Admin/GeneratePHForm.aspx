<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false" Inherits="ALOD.Web.Admin.GeneratePHForm" Codebehind="GeneratePHForm.aspx.vb" %>
            ...
            <div class="dataBlock-body">
                <table>
                    <tr>
                        ...
                        <td class="value">
                            <asp:TextBox ID="txtCaseId" runat="server" MaxLength="15" Width="130px"></asp:TextBox>
                            ...
                            <asp:RegularExpressionValidator ID="regxCaseId" runat="server" ControlToValidate="txtCaseId"
                                Display="Dynamic" ErrorMessage="Invalid Value." ValidationExpression="\d{8}-\d{3}-PH"
                    ...
                    <tr>
                        ...
                        <td class="value">
                            <asp:Button runat="server" ID="btnSubmit" Text="Submit" ValidationGroup="input" CausesValidation="true" />
                        </td>
                    </tr>
                </table>
            </div>
