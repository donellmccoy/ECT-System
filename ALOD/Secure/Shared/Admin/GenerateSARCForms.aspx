<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false" Inherits="ALOD.Web.Admin.GenerateSARCForms" Codebehind="GenerateSARCForms.aspx.vb" %>
                    ...
                    <tr>
                        ...
                        <td class="value">
                            ...
                            <asp:RegularExpressionValidator ID="regxCaseId" runat="server" ControlToValidate="txtCaseId"
                                Display="Dynamic" ErrorMessage="Invalid Value." ValidationExpression="\d{8}-\d{3}-SA"
