<%@ Page Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false" Inherits="ALOD.Web.SecureAccessDenied" title="Untitled Page" Codebehind="SecureAccessDenied.aspx.vb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentMain" Runat="Server">
    ...
    <p>
        <asp:Image ID="imgExclamationIcon2" runat="server" ImageAlign="AbsMiddle" SkinID="imgExclamation" />
        <asp:Label runat="server" ID="lblAdditionalComments" CssClass="deniedText" Text="Please speak to your RMU Medical Technician for case details." />
    </p>
