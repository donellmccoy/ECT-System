...
Namespace Web.Special_Case.IN
    ...
    Partial Class Secure_sc_in_init
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            Dim userAccess As PageAccess.AccessLevel = SCDao.GetUserAccess(SESSION_USER_ID, refId, ModuleType.SpecCaseIncap)

            Utility.VerifyUserAccess(userAccess, Resources.Messages.ERROR_NO_ACCESS, Resources._Global.StartPage)

            Dim scIN As SC_Incap = MasterPage.LoadCase(refId)

            Session("refId") = refId

            Utility.UpdateCaseLock(userAccess, refId, ModuleType.SpecCaseIncap)

            MasterPage.InitPageAccess(scIN)

            Dim startPage As String = MasterPage.GetStartPageTitle(scIN.Status)
