<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/SC_Incap/SC_Incap.master" AutoEventWireup="false" Inherits="ALOD.Web.Special_Case.IN.Secure_sc_in_NextAction" MaintainScrollPositionOnPostback="true" Codebehind="NextAction.aspx.vb" %>
            ...
            <table>
                <tr>
                    ...
                    <td class="value">
                        ...
                        <asp:UpdatePanel runat="server" ID="OptionPanel">
                            <ContentTemplate>
