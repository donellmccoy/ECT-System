...
Namespace Web.Special_Case.DW
    ...
    Partial Class Secure_SC_DW_MedOff
...
#Region "Fields"
        ...
        Private _specCase As SC_DW = Nothing
...
#Region "Page Methods"
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            If (Not IsPostBack) Then
                ...
                LogManager.LogAction(ModuleType.SpecCaseDW, UserAction.ViewPage, RefId, "Viewed Page: Medical Officer Desicion")
            End If
        End Sub
