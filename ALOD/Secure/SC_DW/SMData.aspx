<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/SC_DW/SC_DW.master" AutoEventWireup="false" Async="true" Inherits="ALOD.Web.Special_Case.DW.Secure_SC_DW_SMData" Codebehind="SMData.aspx.vb" %>
        ...
        <div class="dataBlock-body">
            <table class="dataTable">
                ...
                <tr>
                    ...
                    <td class="value">
                        <asp:Label ID="lblSimDeploy" runat="server"></asp:Label>
                    </td>
                </tr>
