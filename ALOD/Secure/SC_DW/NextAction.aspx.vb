...
Namespace Web.Special_Case.DW
    ...
    Partial Class Secure_SC_DW_NextAction
        ...
        Private boardStages As Short() = New Short() {
            CShort(SpecCaseDWStatusCode.PackageReview),
            CShort(SpecCaseDWStatusCode.MedicalReview),
            CShort(SpecCaseDWStatusCode.SeniorMedicalReview),
            CShort(SpecCaseDWStatusCode.FinalReview),
            CShort(SpecCaseDWStatusCode.FinalReviewPending)}
        ...
        Private unitStages As Short() = New Short() {
            CShort(SpecCaseDWStatusCode.InitiateCase)}

#Region "SC_DWProperty"
...
#End Region
        ...
        Protected Function GetStatusInfo(ByVal statusCodeOut As Integer) As Tuple(Of Integer, String)
            ...
            Select Case statusCodeOut
                Case SpecCaseDWStatusCode.InitiateCase
                    sentTo = "Medical Technician"
                    sentToId = UserGroups.MedicalTechnician
                Case SpecCaseDWStatusCode.PackageReview, SpecCaseDWStatusCode.FinalReview, SpecCaseDWStatusCode.FinalReviewPending
                    sentTo = "HQ AFRC Technician"
                    sentToId = UserGroups.AFRCHQTechnician
                Case SpecCaseDWStatusCode.MedicalReview
                    sentTo = "Board Medical"
                    sentToId = UserGroups.BoardMedical
                Case SpecCaseDWStatusCode.SeniorMedicalReview
        ...
        Private Sub ShowRLB()
            Dim access As ALOD.Core.Domain.Workflow.PageAccessType = SectionList(DWSectionNames.DW_RLB.ToString())
...
#Region "ChangeStatusAndActions"
        ...
        Public Sub AddEmails(ByRef emails As MailManager, emailService As EmailService, action As WorkflowOptionAction, statusOut As Integer)
            ...
            If (statusOut = SpecCaseDWWorkStatus.Complete) Then
        ...
        Public Sub ReturnBack(ByVal statusIn As Integer, ByVal statusOut As Integer, ByVal ReturnFlag As Boolean)
            ...
            If (rwRec IsNot Nothing AndAlso rwRec.DateSentBack Is Nothing) Then
                ...
                ElseIf (statusCodeOut = SpecCaseDWStatusCode.Cancel) Then           'Case was canceled during Return
                    rwRec.DateSentBack = DateTime.Now
                ...
                ElseIf (statusCodeOut = SpecCaseDWStatusCode.Complete) Then            'Case was completed during Return
