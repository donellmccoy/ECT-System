...
Namespace Web.Special_Case.DW
    ...
    Partial Class Secure_SC_DW_init
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            Dim userAccess As PageAccess.AccessLevel = SCDao.GetUserAccess(SESSION_USER_ID, refId, ModuleType.SpecCaseDW)

            Utility.VerifyUserAccess(userAccess, Resources.Messages.ERROR_NO_ACCESS, Resources._Global.StartPage)

            Dim scDW As SC_DW = MasterPage.LoadCase(refId)

            Session("refId") = refId

            Utility.UpdateCaseLock(userAccess, refId, ModuleType.SpecCaseDW)

            MasterPage.InitPageAccess(scDW)

            Dim startPage As String = MasterPage.GetStartPageTitle(scDW.Status)
