...
Namespace Web.Special_Case.AGR
    ...
    Partial Class Secure_sc_agr_init
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            Dim userAccess As PageAccess.AccessLevel = SCDao.GetUserAccess(SESSION_USER_ID, refId, ModuleType.SpecCaseAGR)

            Utility.VerifyUserAccess(userAccess, Resources.Messages.ERROR_NO_ACCESS, Resources._Global.StartPage)

            Dim scAGR As SC_AGRCert = MasterPage.LoadCase(refId)

            Session("refId") = refId

            Utility.UpdateCaseLock(userAccess, refId, ModuleType.SpecCaseAGR)

            MasterPage.InitPageAccess(scAGR)

            Dim startPage As String = MasterPage.GetStartPageTitle(scAGR.Status)
