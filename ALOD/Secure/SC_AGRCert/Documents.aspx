<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/SC_AGRCert/SC_AGRCert.master" AutoEventWireup="false" Inherits="ALOD.Web.Special_Case.AGR.Secure_sc_agr_Documents" MaintainScrollPositionOnPostback="true" Codebehind="Documents.aspx.vb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentNested" runat="Server">
    ...
    <%--<table>
        <tr>
            ...
            <td style="width: 444px;text-align: right;" colspan="3">
            <asp:Label ID="FastTrackTypeLabel" 
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterNested" runat="Server">
    <script type="text/javascript">
        ...
        function showEditor(memo, template, mod) {
            ...
            //var url = strReturnPath + "/Secure/Shared/Memos/EditMemo.aspx?id=" + refId + "&template=" + template + "&memo=" + memo + "&mod=" + mod;
