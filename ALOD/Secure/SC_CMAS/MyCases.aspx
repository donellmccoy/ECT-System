<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false"
    Async="true" Inherits="ALOD.Web.Special_Case.CMAS.Secure_cmas_MyCases" Codebehind="MyCases.aspx.vb" %>
    ...
    <asp:UpdatePanel ID="resultsUpdatePanel" runat="server" ChildrenAsTriggers="True">
        <ContentTemplate>
            ...
            <div style="font-weight: bold">
                My Cases:
                <%= WorkflowDao.GetCaseType(14, 0) %></div>
            ...
            <div style="font-weight: bold">
                My Cases: <%= WorkflowDao.GetCaseType(14, 0) %> - Waiting on Disposition Response
            </div>
            ...
            <div style="font-weight: bold">
                My Cases: <%= WorkflowDao.GetCaseType(14, 0)%> - Holding
            </div>
