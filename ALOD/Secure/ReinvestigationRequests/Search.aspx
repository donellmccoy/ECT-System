<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false" Inherits="ALOD.Web.RR.Search" Codebehind="Search.aspx.vb" %>

<asp:Content runat="Server" ID="Content2" ContentPlaceHolderID="ContentFooter">
    <script type="text/javascript">

        //function printForms(id) {
        //    var url = $_HOSTNAME + "/secure/ReinvestigationRequests/Print.aspx?id=" + id;
...
<%--                        <asp:TemplateField HeaderText="Print">
    ...
    <asp:ObjectDataSource ID="StatusData" runat="server" SelectMethod="GetWorkstatusByWorkflow" TypeName="ALOD.Data.Services.LookupService">
        <SelectParameters>
            <asp:Parameter DefaultValue="5" Name="workflow" Type="Byte" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="SearchData" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ReinvestigationRequestSearch" TypeName="ALOD.Data.Services.LodService">
        <SelectParameters>
            ...
            <asp:Parameter DefaultValue="5" Name="moduleId" Type="Byte" />
