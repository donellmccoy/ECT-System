<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/ReinvestigationRequests/ReinvestigationRequest.master" AutoEventWireup="false" Inherits="ALOD.Web.RR.SeniorMedReviewer" Codebehind="SeniorMedReviewer.aspx.vb" %>
        ...
        <ContentTemplate>
            <div class="dataBlock" id="SeniorMedical" runat="server">
                <div class="dataBlock-header">
                    Senior Medical Reviewer RR Decision
                </div>
