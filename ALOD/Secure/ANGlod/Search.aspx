<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false" Inherits="ALOD.Web.LOD.Secure_lod_Search"  Async="true" Codebehind="Search.aspx.vb" %>
...
<%--                    <label for="txtLastName">Last Name:</label>
                    ...
                    <asp:DropDownList ID="FormalSelect" AutoPostBack="True" runat="server" Width="100px">
    ...
    <asp:ObjectDataSource ID="StatusData" runat="server" SelectMethod="GetStatusCodesByModule"
        TypeName="ALOD.Data.Services.LookupService">
        <SelectParameters>
            <asp:Parameter DefaultValue="2" Name="moduleId" Type="Byte" />
        </SelectParameters>
    </asp:ObjectDataSource>

    <asp:ObjectDataSource ID="SearchData" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetAllLods" TypeName="ALOD.Data.Services.LodService">
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtMiddleName" Name="middleInitial" PropertyName="Text" Type="String" />--%>
            ...
            <asp:Parameter DefaultValue="2" Name="moduleId" Type="Byte" />
            <asp:ControlParameter ControlID="FormalSelect" DefaultValue="" Name="IsFomal" PropertyName="SelectedValue" Type="String" />
