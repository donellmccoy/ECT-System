...
#End Region
        ...
        Protected Sub SearchData_Selecting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceSelectingEventArgs) Handles SearchData.Selecting
            ...
            If (SsnBox.Text.Trim.Length = 0 AndAlso _
                NameBox.Text.Trim.Length = 0 AndAlso _
                CaseIdBox.Text.Trim.Length = 0 AndAlso _
                StatusSelect.SelectedIndex = 0 AndAlso _
                FormalSelect.SelectedIndex = 0 AndAlso _
