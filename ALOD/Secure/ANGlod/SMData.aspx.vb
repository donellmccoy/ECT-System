...
#Region "Page Methods"
        ...
        Protected Sub LoadPostProcessingData()
            ...
            If (LOD.NotificationMemoCreated(DaoFactory.GetMemoDao())) Then
        ...
        Protected Function CanDigitallySign() As Boolean
            ...
            If (Not LOD.NotificationMemoCreated(DaoFactory.GetMemoDao())) Then
                Return False
            End If
        ...
        Private Function UserHasPermissionToChangeCaseUnit() As Boolean
            If (Not UserHasPermission(PERMISSION_SYSTEM_ADMIN))
                Return False
            End If
