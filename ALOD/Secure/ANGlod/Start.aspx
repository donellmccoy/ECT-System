<%@ Page Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false" Inherits="ALOD.Web.LOD.Secure_lod_Start" Title="Untitled Page" Codebehind="Start.aspx.vb" %>
            ...
            <div class="dataBlock-body">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="value">
                            ...
                            <asp:DropDownList ID="WorkflowSelect" runat="server" Visible="false">
                                ...
                                <asp:ListItem Selected="True" Text="LOD V2" Value="27"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="label labelRequired">
                            * Did the member notify the RMU timely IAW AFI 36-2910:
                        </td>
                        <td class="value">
                    ...
                    <tr>
                        ...
                        <td class="value">
                            <asp:Panel runat="server" ID="SarcPanel">
                                <asp:RadioButton GroupName="sarc" runat="server" ID="SarcYes" Text="Yes" CssClass="sarc" />
                                <asp:RadioButton GroupName="sarc" runat="server" ID="SarcNo" Text="No" CssClass="sarc" />
                            </asp:Panel>
                    ...
                    <tr>
                        ...
                        <td class="label restricted-label">
