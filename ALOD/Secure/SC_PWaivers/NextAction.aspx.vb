...
Namespace Web.Special_Case.PW
    ...
    Partial Class Secure_sc_pw_NextAction
        ...
        Private boardStages As Short() = New Short() {
            CShort(SpecCasePWStatusCode.PackageReview),
            CShort(SpecCasePWStatusCode.MedicalReview),
            CShort(SpecCasePWStatusCode.SeniorMedicalReview),
            CShort(SpecCasePWStatusCode.FinalReview)}

        Private CANCELLATION_REASON As String = "Case Cancelled By "
        Private errors As New List(Of ValidationItem)
        Private sc As SC_PWaivers
        Private separatorTemplate As System.Web.UI.CompiledTemplateBuilder

        Private unitStages As Short() = New Short() {
            CShort(SpecCasePWStatusCode.InitiateCase)}
...
#End Region
        ...
        Protected Function GetStatusInfo(ByVal statusCodeOut As Integer) As Tuple(Of Integer, String)
            ...
            Select Case statusCodeOut
                Case SpecCasePWStatusCode.InitiateCase
                    sentTo = "Medical Technician"
                    sentToId = UserGroups.MedicalTechnician
                Case SpecCasePWStatusCode.PackageReview, SpecCasePWStatusCode.FinalReview
                    sentTo = "HQ AFRC Technician"
                    sentToId = UserGroups.AFRCHQTechnician
                Case SpecCasePWStatusCode.MedicalReview
                    sentTo = "Board Medical"
                    sentToId = UserGroups.BoardMedical
                Case SpecCasePWStatusCode.SeniorMedicalReview
        ...
        Private Sub ShowRLB()
            Dim access As ALOD.Core.Domain.Workflow.PageAccessType = SectionList(PWSectionNames.PW_RLB.ToString())
...
#Region "ChangeStatusAndActions"
        ...
        Public Sub AddEmails(ByRef emails As MailManager, emailService As EmailService, action As WorkflowOptionAction, statusOut As Integer)
            ...
            If (statusOut = SpecCasePWWorkStatus.Approved Or statusOut = SpecCasePWWorkStatus.Denied) Then
        ...
        Public Sub ReturnBack(ByVal statusIn As Integer, ByVal statusOut As Integer, ByVal ReturnFlag As Boolean)
            ...
            If (rwRec IsNot Nothing AndAlso rwRec.DateSentBack Is Nothing) Then
                ...
                ElseIf (statusCodeOut = SpecCasePWStatusCode.Cancelled) Then           'Case was canceled during Return
                    rwRec.DateSentBack = DateTime.Now
                ...
                ElseIf (statusCodeOut = SpecCasePWStatusCode.Approved OrElse statusCodeOut = SpecCasePWStatusCode.Denied) Then            'Case was completed during Return
