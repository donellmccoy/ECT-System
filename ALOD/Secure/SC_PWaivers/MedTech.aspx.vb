...
Namespace Web.Special_Case.PW
    ...
    Partial Class Secure_sc_pw_MedTech
...
#End Region
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If (Not IsPostBack) Then
                ...
                LogManager.LogAction(ModuleType.SpecCasePW, UserAction.ViewPage, RefId, "Viewed Page: Participation Waiver Medical Technician")
        ...
        Private Sub InitControls()
            ...
            If Not IsNothing(SpecCase.PWaiverCategory) Then
                PWCategoryDropdownListSelect.SelectedValue = SpecCase.PWaiverCategory
            End If
            ...
            If UserCanEdit Then
                ...
                'Category
                PWCategoryDropdownListSelect.Enabled = True
            ...
            Else
                ...
                'Category
                PWCategoryDropdownListSelect.Enabled = False
        ...
        Private Sub SaveFindings()
            ...
            PageAccess = SectionList(PWSectionNames.PW_BOARD_SG_REV.ToString())
            ...
            If (SpecCase.Status = SpecCasePWWorkStatus.InitiateCase) Then

                'Category
                sc.PWaiverCategory = PWCategoryDropdownListSelect.SelectedValue

                If (sc.PWaiverCategory <> 0) Then
                    sc.PWaiverCategoryDescription = PWCategoryDropdownListSelect.SelectedItem.Text
                End If
