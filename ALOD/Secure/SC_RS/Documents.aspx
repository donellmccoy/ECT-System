<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/SC_RS/SC_RS.master" AutoEventWireup="false" Inherits="ALOD.Web.Special_Case.RS.Secure_sc_rs_Documents" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" Codebehind="Documents.aspx.vb" %>
        ...
        <table class="docHeader">
            <tr>
                ...
                <td style="width: 300px; text-align: right;" colspan="3">
                    <asp:Image runat="server" ID="CreateMemo" ImageAlign="AbsMiddle" ImageUrl="~/images/create_document.gif" CssClass="iconUpload" AlternateText="Create New RS Memo" />
                </td>
            </tr>
        </table>
