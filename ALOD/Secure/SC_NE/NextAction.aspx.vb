...
Namespace Web.Special_Case.NE
    ...
    Partial Class Secure_sc_ne_NextAction
        ...
        Private boardStages As Short() = New Short() {
            CShort(SpecCaseNEStatusCode.PackageReview),
            CShort(SpecCaseNEStatusCode.MedicalReview),
            CShort(SpecCaseNEStatusCode.SeniorMedicalReview),
            CShort(SpecCaseNEStatusCode.FinalReview)}
        ...
        Private unitStages As Short() = New Short() {
            CShort(SpecCaseNEStatusCode.InitiateCase)}

#Region "SC_NEProperty"
...
#End Region
        ...
        Protected Function GetStatusInfo(ByVal statusCodeOut As Integer) As Tuple(Of Integer, String)
            ...
            Select Case statusCodeOut
                Case SpecCaseNEStatusCode.InitiateCase
                    sentTo = "Medical Technician"
                    sentToId = UserGroups.MedicalTechnician
                Case SpecCaseNEStatusCode.PackageReview, SpecCaseNEStatusCode.FinalReview
                    sentTo = "HQ AFRC Technician"
                    sentToId = UserGroups.AFRCHQTechnician
                Case SpecCaseNEStatusCode.MedicalReview
                    sentTo = "Board Medical"
                    sentToId = UserGroups.BoardMedical
                Case SpecCaseNEStatusCode.SeniorMedicalReview
        ...
        Private Sub ShowRLB()
            Dim access As ALOD.Core.Domain.Workflow.PageAccessType = SectionList(NESectionNames.NE_RLB.ToString())
...
#Region "ChangeStatusAndActions"
        ...
        Public Sub AddEmails(ByRef emails As MailManager, emailService As EmailService, action As WorkflowOptionAction, statusOut As Integer)
            ...
            If (statusOut = SpecCaseNEWorkStatus.Approved Or statusOut = SpecCaseNEWorkStatus.Denied) Then
        ...
        Public Sub ReturnBack(ByVal statusIn As Integer, ByVal statusOut As Integer, ByVal ReturnFlag As Boolean)
            ...
            If (rwRec IsNot Nothing AndAlso rwRec.DateSentBack Is Nothing) Then
                ...
                ElseIf (statusCodeOut = SpecCaseNEStatusCode.Cancelled) Then           'Case was canceled during Return
                    rwRec.DateSentBack = DateTime.Now
                ...
                ElseIf (statusCodeOut = SpecCaseNEStatusCode.Approved OrElse statusCodeOut = SpecCaseNEStatusCode.Denied) Then            'Case was completed during Return
