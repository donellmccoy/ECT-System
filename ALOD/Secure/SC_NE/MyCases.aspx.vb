...
Namespace Web.Special_Case.NE
    ...
    Partial Class Secure_ne_MyCases
        ...
        Private Sub gvDisposition_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs) Handles gvDisposition.RowCommand
