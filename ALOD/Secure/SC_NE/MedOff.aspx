<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/SC_NE/SC_NE.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" Inherits="ALOD.Web.Special_Case.NE.Secure_sc_ne_MedOff" Codebehind="MedOff.aspx.vb" %>

<%@ Reference Control="~/Secure/Shared/UserControls/FindingsControl.ascx" %>
<%@ Reference Control="~/Secure/Shared/UserControls/TabNavigator.ascx" %>
<%@ MasterType VirtualPath="~/Secure/SC_NE/SC_NE.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentNested" runat="Server">
    ...
    <asp:Panel runat="server" ID="pnlBoardMedicalInformation" CssClass="dataBlock">
        <div class="dataBlock-header">
            Medical Officer NE Decision
        </div>
        <div class="dataBlock-body">
            <table>
                <tr>
                    <td>
                        <asp:RadioButton runat="server" ID="DecisionY" GroupName="Decision" Text="Approve Non-Emergent Surgery Request" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:RadioButton runat="server" ID="DecisionN" GroupName="Decision" Text="Deny Non-Emergent Surgery Request" />
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <asp:Panel runat="server" Id="pnlSeniorMedialReviewerInformation" CssClass="dataBlock">
        <div class="dataBlock-header">
            Senior Medical Reviewer NE Decision
        </div>
        <div class="dataBlock-body">
            <table>
                <tr>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:Panel runat="server" ID="pnlSeniorMedicalReviewerFindings" CssClass="FindingsIndent" Visible="False">
                                    <asp:RadioButtonList runat="server" ID="rblSeniorMedicalReviewerFindings" RepeatDirection="Vertical">
                                        <asp:ListItem Value="1">Approve Non-Emergent Surgery Request</asp:ListItem>
                                        <asp:ListItem Value="0">Deny Non-Emergent Surgery Request</asp:ListItem>
                                    </asp:RadioButtonList>
                                </asp:Panel>
                            </ContentTemplate>
                        </asp:UpdatePanel>
