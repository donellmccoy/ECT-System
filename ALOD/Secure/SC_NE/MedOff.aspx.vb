...
Namespace Web.Special_Case.NE
    ...
    Partial Class Secure_sc_ne_MedOff
...
#Region "Page Methods"
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            If (Not IsPostBack) Then
                ...
                InitControls()
                ValidateControls()
                LogManager.LogAction(ModuleType.SpecCaseNE, UserAction.ViewPage, RefId, "Viewed Page: Medical Officer Desicion")
            End If
        End Sub
