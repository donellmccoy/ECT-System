<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false"
    Async="true" Inherits="ALOD.Web.Special_Case.NE.Secure_ne_MyCases" Codebehind="MyCases.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentMain" runat="Server">
    ...
    <asp:UpdatePanel ID="resultsUpdatePanel" runat="server" ChildrenAsTriggers="True">
        <ContentTemplate>
            ...
            <div style="font-weight:bold">My Cases: <%= WorkflowDao.GetCaseType(18, 0)%></div>
            ...
            <div style="font-weight: bold">
                My Cases: <%= WorkflowDao.GetCaseType(18, 0) %> - Waiting on Disposition Response
            </div>
            ...
            <div style="font-weight: bold">
                My Cases: <%= WorkflowDao.GetCaseType(18, 0)%> - Holding
            </div>
