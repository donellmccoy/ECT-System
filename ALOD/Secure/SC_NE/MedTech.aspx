<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/SC_NE/SC_NE.master"
    MaintainScrollPositionOnPostback="true" AutoEventWireup="false"
     EnableEventValidation="false" Inherits="ALOD.Web.Special_Case.NE.Secure_sc_ne_MedTech" Codebehind="MedTech.aspx.vb" %>
    ...
    <div class="dataBlock">
        ...
        <table>
            <tr>
                ...
                <td class="label  labelRequired">*Surgery Date:</td>
                <td><asp:TextBox ID="NESurgeryDateTextBox" MaxLength="10"
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterNested" runat="Server">
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('.datePickerFuture').datepicker(calendarPick("TomorrowFuture", "<%=CalendarImage %>"));
