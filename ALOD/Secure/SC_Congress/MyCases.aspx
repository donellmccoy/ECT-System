<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false"
    Async="true" Inherits="ALOD.Web.Special_Case.CI.Secure_ci_MyCases" Codebehind="MyCases.aspx.vb" %>
    ...
    <asp:UpdatePanel ID="resultsUpdatePanel" runat="server" ChildrenAsTriggers="True">
        <ContentTemplate>
            ...
            <div style="font-weight: bold">
                My Cases:
                <%= WorkflowDao.GetCaseType(7, 0)%></div>
            ...
            <div style="font-weight: bold">
                My Cases: <%= WorkflowDao.GetCaseType(7, 0) %> - Waiting on Disposition Response
            </div>
            ...
            <br /><br />
             ...
             <div style="font-weight: bold">
                My Cases: <%= WorkflowDao.GetCaseType(7, 0)%> - Holding
            </div>
