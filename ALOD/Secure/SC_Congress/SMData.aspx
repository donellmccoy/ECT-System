<%@ Page Language="VB" MasterPageFile="~/Secure/SC_Congress/SC_Congress.master" AutoEventWireup="false" Async="true" Inherits="ALOD.Web.Special_Case.CI.Secure_sc_ci_SMData" Title="Untitled Page" Codebehind="SMData.aspx.vb" %>
