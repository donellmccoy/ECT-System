...
Namespace Web.Special_Case.MO
    ...
    Partial Class Secure_sc_mo_NextAction
        ...
        Private boardStages As Short() = New Short() {
            CShort(SpecCaseMOStatusCode.HQAFRCTechInitiateCase),
            CShort(SpecCaseMOStatusCode.PackageReview),
            CShort(SpecCaseMOStatusCode.SeniorMedicalReview),
            CShort(SpecCaseMOStatusCode.MedicalReview),
            CShort(SpecCaseMOStatusCode.FinalReview)}
        ...
        Private unitStages As Short() = New Short() {
            CShort(SpecCaseMOStatusCode.MedTechInitiateCase)}

#Region "SC_MOProperty"
...
#End Region
        ...
        Protected Function GetStatusInfo(ByVal statusCodeOut As Integer) As Tuple(Of Integer, String)
            ...
            Select Case statusCodeOut
                Case SpecCaseMOStatusCode.MedTechInitiateCase
                    sentTo = "Medical Technician"
                    sentToId = UserGroups.MedicalTechnician
                Case SpecCaseMOStatusCode.HQAFRCTechInitiateCase, SpecCaseMOStatusCode.PackageReview, SpecCaseMOStatusCode.FinalReview
                    sentTo = "HQ AFRC Technician"
                    sentToId = UserGroups.AFRCHQTechnician
                Case SpecCaseMOStatusCode.MedicalReview
                    sentTo = "Board Medical"
                    sentToId = UserGroups.BoardMedical
                Case SpecCaseMOStatusCode.SeniorMedicalReview
        ...
        Private Sub ShowRLB()
            Dim access As ALOD.Core.Domain.Workflow.PageAccessType = SectionList(MOSectionNames.MO_RLB.ToString())
...
#Region "ChangeStatusAndActions"
        ...
        Public Sub AddEmails(ByRef emails As MailManager, emailService As EmailService, action As WorkflowOptionAction, statusOut As Integer)
            ...
            If (statusOut = SpecCaseMOWorkStatus.Approved Or statusOut = SpecCaseMOWorkStatus.Denied) Then
        ...
        Public Sub ReturnBack(ByVal statusIn As Integer, ByVal statusOut As Integer, ByVal ReturnFlag As Boolean)
            ...
            If (rwRec IsNot Nothing AndAlso rwRec.DateSentBack Is Nothing) Then
                ...
                ElseIf (statusCodeOut = SpecCaseMOStatusCode.Cancelled) Then           'Case was canceled during Return
                    rwRec.DateSentBack = DateTime.Now
                ...
                ElseIf (statusCodeOut = SpecCaseMOStatusCode.Approved OrElse statusCodeOut = SpecCaseMOStatusCode.Denied) Then            'Case was completed during Return
