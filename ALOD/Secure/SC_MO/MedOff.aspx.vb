...
Namespace Web.Special_Case.MO
    ...
    Partial Class Secure_sc_mo_MedOff
...
#Region "Page Methods"
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            If (Not IsPostBack) Then
                ...
                InitControls()
                ValidateControls()
                LogManager.LogAction(ModuleType.SpecCaseMO, UserAction.ViewPage, RefId, "Viewed Page: Medical Officer Desicion")
            End If
        End Sub
        ...
        Private Sub LoadBoardMedicalFindings()
            ...
            If (Not IsNothing(SpecCase.med_off_approved)) Then
