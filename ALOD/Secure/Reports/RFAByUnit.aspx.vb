...
Namespace Web.Reports
    ...
    Partial Class Secure_Reports_RFAByUnit
        ...
        Protected Sub rfaRptGrid_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles rfaRptGrid.PageIndexChanging
            rfaRptGrid.PageIndex = e.NewPageIndex
            FillGrid()
        End Sub

        Protected Sub rfaRptGrid_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles rfaRptGrid.RowDataBound
        ...
        Protected Sub rfaRptGrid_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles rfaRptGrid.Sorting
            rfaRptGrid.PageIndex = 0
            If (SortColumn <> "") Then
        ...
        Private Sub FillGrid()
            Dim ds As DataSet = ReportsDao.ExecuteRFAByUnitReport(BeginDate, EndDate)
