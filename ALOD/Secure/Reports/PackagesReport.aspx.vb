...
Namespace Web.Reports
    ...
    Partial Class Secure_Reports_PackagesReport
        ...
        Private Property SortColumn() As String
            Get
                If (ViewState(SORT_COLUMN_KEY) Is Nothing) Then
                    ViewState(SORT_COLUMN_KEY) = "pkgName"
                End If
        ...
        Protected Sub pkgRptGrid_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles pkgRptGrid.PageIndexChanging
            pkgRptGrid.PageIndex = e.NewPageIndex
            FillGrid()
        End Sub

        Protected Sub pkgRptGrid_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles pkgRptGrid.RowDataBound
        ...
        Protected Sub pkgRptGrid_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles pkgRptGrid.Sorting
            pkgRptGrid.PageIndex = 0
            If (SortColumn <> "") Then
        ...
        Private Sub FillGrid()
            Dim ds As DataSet = ReportsDao.ExecutePackagesReport(BeginDate, EndDate)
