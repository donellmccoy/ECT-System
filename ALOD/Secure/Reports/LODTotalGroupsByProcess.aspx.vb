Namespace Web.Reports
    ...
    Partial Class Secure_Reports_LODTotalGroupsByProcess
...
#End Region
        ...
        '        ' FillGrid(rptTemplate.Unit, CInt(Session("ReportView")), rptTemplate.UnitText)
        '        _chain.Clear()
        '        AddChain(CInt(Session("UnitId")), ALodRptList.GetUnitText(CInt(Session("unitId"))))
        ...
        '        ' FillGrid(CInt(args(0)), CInt(Session("ReportView")), args(1))
        '        ViewState("drill") = _chain
        '        SetNavigator()
...
#Region "ReportView"
        ...
        '        Dim unitName = args(1)
        '        '  FillGrid(cs_id, CInt(Session("ReportView")), unitName)
        ...
        '    SelectedCSID = cs_id
        '    Dim ds As System.Data.DataSet = ALodRptList.GetOpenStatusCount(cs_id, CInt(Session("ReportView")), rptTemplate.BeginDate, rptTemplate.EndDate)

        '    ReportGridView.DataSource = ds
        '    ReportGridView.DataBind()
        '    rowDetail.Visible = False

        '    fillDetailGrid(cs_id, viewType)
...
#Region "DetailView"
        ...
        '    fillDetailGrid(LastCSID, CInt(Session("ReportView")))
        ...
        'Private Sub fillDetailGrid(ByVal cs_id As Integer, ByVal viewType As Integer)
        '    DetailGridView.DataSource = ALodRptList.GetStatusDetail(cs_id, viewType, rptTemplate.BeginDate, rptTemplate.EndDate)
        '    DetailGridView.DataBind()
        'End Sub
