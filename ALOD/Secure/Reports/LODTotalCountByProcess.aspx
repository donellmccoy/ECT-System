<%@ Page Title="" Language="vb" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false" Inherits="ALOD.Web.Reports.LODTotalCountByProcess" CodeBehind="LODTotalCountByProcess.aspx.vb" %>
                        ...
                        <div id="rpt">
                            ...
                            <asp:GridView ID="ReportGridView" runat="server" Width="100%" DataKeyNames="cs_id,viewType"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ShowHeader="true" HeaderText="LOD PM" SortExpression="lodPM">
                                        <ItemTemplate>
                                            <%#Eval("lodPM")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
