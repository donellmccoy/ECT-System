...
Namespace Web.Reports
    ...
    Public Class LODTotalCountByProcess
        ...
        Private _medicalCount As Integer
        ...
        Protected ReadOnly Property ReportView As Integer
            Get
        ...
        Protected Function ConstructReportArgs(ByVal cs_id As Integer) As LODTotalCountByProcessReportArgs
            Dim args As LODTotalCountByProcessReportArgs = New LODTotalCountByProcessReportArgs()

            args.UnitId = cs_id
            args.ReportView = ReportView
        ...
        Protected Sub InitReportNavControl()
            ...
            rptTemplate.ControlVisibility(Secure_Shared_UserControls_ReportNav.CtrlList.LODStatus, False)
        End Sub
        ...
        Protected Sub ReportGridView_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles ReportGridView.PageIndexChanging
            ...
            SortGridView(LastCSID, LastUnitName)
        End Sub
        ...
        Protected Sub rptNav_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.RepeaterCommandEventArgs) Handles rptNav.ItemCommand
            ...
            If (e.CommandName <> String.Empty) Then
                ...
                For Each item As KeyValuePair(Of Integer, String) In CType(ViewState("drill"), Dictionary(Of Integer, String))
                    ...
                    End If
                Next
                SortGridView(CInt(args(0)), args(1))

                ViewState("drill") = _chain
                SetUnitNavigator()
                rptTemplate.FillUnitLookup(CInt(args(0)), ReportView)
            End If
        End Sub
        ...
        Protected Sub rptNav_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles rptNav.ItemDataBound
            ...
            lnk.Text = item.Value
            lnk.CommandName = item.Key.ToString() + ";" + item.Value ''This adds the unit and name
        End Sub
        ...
        Private Sub fillDetailGrid(ByVal cs_id As Integer)
            DetailGridView.DataSource = ReportsDao.ExecuteLODTotalCountByProcessDetailsReport(ConstructReportArgs(cs_id))
            DetailGridView.DataBind()
        End Sub

        Private Sub FillGrid(ByVal cs_id As Integer, ByVal unitName As String)
            SelectedCSID = cs_id
            ReportGridView.DataSource = ReportsDao.ExecuteLODTotalCountByProcessReport(ConstructReportArgs(cs_id))
        ...
        Private Sub RunReport(ByVal sender As Object, ByVal e As EventArgs)
            If (Page.IsValid) Then
                SortGridView(rptTemplate.Unit, rptTemplate.UnitText)
                _chain.Clear()
        ...
        Private Sub SortGridView(ByVal csId As Integer, ByVal unitName As String)
            FillGrid(csId, unitName)
