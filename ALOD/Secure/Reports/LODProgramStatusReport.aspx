<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Secure/Secure.master" CodeBehind="LODProgramStatusReport.aspx.vb" Inherits="ALOD.Web.Reports.LODProgramStatusReport" MaintainScrollPositionOnPostback="true"%>
    ...
    <asp:Panel runat="server" ID="pnlReportOptions" CssClass="indent-small dataBlock">
        ...
        <div class="dataBlock-body flexPanel">
            <div class="optionsPanel">
                <asp:UpdatePanel runat="server" ID="upnlReportOptions">
                    <ContentTemplate>
                        <table>
                            <tr>
                                <td class="number">
        ...
        <asp:Panel runat="server" ID="pnlReportResults" CssClass="indent-small dataBlock" Visible="true">
            ...
            <div class="dataBlock-body">
                ...
                <div runat="server" id="pnlHorizontalScrollPanel" class="horizontalScrollPanel">
                    <asp:GridView runat="server" SkinID="TestGV" ID="gdvResults" AutoGenerateColumns="False" Width="1500px" DataKeyNames="RefId">
                        <Columns>
