<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false"
    Async="true" Inherits="ALOD.Web.AP.Secure_ap_MyRequests" Codebehind="MyRequests.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentMain" runat="Server">
            ...
            <asp:GridView ID="gvResults" runat="server" EmptyDataText="No records found" EmptyDataRowStyle-CssClass="emptyItem"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Case Id" SortExpression="Case_Id" ItemStyle-Width="150px">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkRefID" runat="server" CommandArgument='<%# Eval("appeal_Id").ToString()%>'
    ...
    <asp:ObjectDataSource ID="LodData"  runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetAppealRequests" TypeName="ALOD.Data.Services.LodService">
        <SelectParameters>
    ...
    <asp:ObjectDataSource ID="LodData2"  runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetCompletedAPs" TypeName="ALOD.Data.Services.LodService">
        <SelectParameters>
            <asp:SessionParameter Name="userId" SessionField="UserId" Type="Int32" />
            <asp:SessionParameter Name="sarc" SessionField="sarc" Type="Byte" />
        </SelectParameters>
