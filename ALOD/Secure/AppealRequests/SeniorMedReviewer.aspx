<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/AppealRequests/AppealRequest.master" AutoEventWireup="false" Inherits="ALOD.Web.AP.SeniorMedReviewer" Codebehind="SeniorMedReviewer.aspx.vb" %>
        ...
        <ContentTemplate>
            <div class="dataBlock" id="SeniorMedical" runat="server">
                <div class="dataBlock-header">
                    Senior Medical Reviewer AP Decision
                </div>
