...
Namespace Web.Special_Case.BMT
    ...
    Partial Class Secure_sc_bmt_NextAction
...
#End Region
        ...
        Protected Function GetStatusInfo(ByVal statusCodeOut As Integer) As Tuple(Of Integer, String)
            ...
            Select Case statusCodeOut
                Case SpecCaseBMTStatusCode.InitiateCase, SpecCaseBMTStatusCode.FinalReview
                    sentTo = "HQ Tech"
                    sentToId = UserGroups.AFRCHQTechnician
                Case SpecCaseBMTStatusCode.MedicalReview
                    sentTo = "Board Medical"
                    sentToId = UserGroups.BoardMedical
                Case SpecCaseBMTStatusCode.SeniorMedicalReview
        ...
        Protected Sub SignButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SignButton.Click
            ...
            CommitChanges()
            SigBlock.StartSignature(RefId, SpecCase.Workflow, secId, workOption.DisplayText, SpecCase.Status, workOption.wsStatusOut, workOption.Id, template, String.Empty)
...
#Region "ChangeStatusAndActions"
        ...
        Public Sub AddEmails(ByRef emails As MailManager, emailService As EmailService, action As WorkflowOptionAction, statusOut As Integer)
            ...
            If (statusOut = SpecCaseBMTWorkStatus.Approved Or statusOut = SpecCaseBMTWorkStatus.Denied) Then
        ...
        Public Sub ReturnBack(ByVal statusIn As Integer, ByVal statusOut As Integer, ByVal ReturnFlag As Boolean)
            ...
            If (rwRec IsNot Nothing AndAlso rwRec.DateSentBack Is Nothing) Then
                ...
                ElseIf (statusCodeOut = SpecCaseBMTStatusCode.Cancelled) Then           'Case was canceled during Return
                    rwRec.DateSentBack = DateTime.Now
                ...
                ElseIf (statusCodeOut = SpecCaseBMTStatusCode.Approved OrElse statusCodeOut = SpecCaseBMTStatusCode.Denied) Then            'Case was completed during Return
                    rwRec.DateSentBack = DateTime.Now
                    If (String.IsNullOrEmpty(rwRec.CommentsBackToSender)) Then
