...
Namespace Web.LOD
    ...
    Partial Class Secure_lod_Start
        ...
        'added caching header to the page 10-11-2023 Diamante Lawson
        ...
        Protected Sub CreateButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CreateButton.Click
            ...
            If (WingRow.Visible) Then
                If (WingNo.Checked) Then
                    'ErrorLabel.Text = Resources.Messages.ERROR_INCORRECT_WING
                    ErrorLabel.Text = "Please process all non Wing members LODs in the legacy LOD Track"
                    ErrorRow1.Visible = True
                    Exit Sub
                End If

                '*** Removed on LOD_V3 "The UNRESTRICTED SA cases are routed just like a regular LOD"
                'If (SarcYes.Checked) Then  'question I
                If (RestrictedYes.Checked) Then 'question J
                    'ErrorLabel.Text = Resources.Messages.ERROR_RSARC_REQUIRED
                    ErrorLabel.Text = "You do not have proper privileges to initiate a restricted sexual assault LOD, please contact the local SARC or ECT administrator"
                    ErrorRow1.Visible = True
                    Exit Sub
                    'Else
                    '    'ErrorLabel.Text = Resources.Messages.ERROR_LEGACY_TRACK_REQUIRED
                    '    ErrorLabel.Text = "Please process all Unrestricted Sexual Assault cases in the legacy LOD Track"
                End If
            ...
            If (Not RestrictedYes.Checked AndAlso Not RestrictedNo.Checked AndAlso Not RadioButtonNA.Checked) Then
            ...
            If (RestrictedYes.Checked) Then
                ...
                If (AppMode = DeployMode.Production) Then
                    CreateSARC()
                Else
                    If (WorkflowSelect.SelectedValue = 1) Then  'Not used - Darel 05/08/2020
                        CreateLOD()
                    Else
                        CreateSARC()
                        Exit Sub
        ...
        Protected Sub OptionLogic()
            If (SarcNo.Checked) Then
                RestrictedYes.Enabled = False
                RestrictedNo.Enabled = False
                RadioButtonNA.Checked = True
            Else
                RestrictedYes.Enabled = True
                RestrictedNo.Enabled = True
                RadioButtonNA.Checked = False
            End If
        End Sub
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If (Not IsPostBack) Then
                ...
                If (SESSION_GROUP_ID = UserGroups.WingSarc Or SESSION_GROUP_ID = UserGroups.RSL) Then
                    ...
                    RestrictedYes.Checked = True
                    'RestrictedNo.Checked = True
                    RestrictedPanel.Enabled = False
                End If
        ...
        Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
            ErrorRow1.Visible = (ErrorLabel.Text.Length > 0)
        End Sub
