<%--<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false" Inherits="ALOD.Web.LOD.Secure_lod_PostCompletionLegacyLOD" Codebehind="PostCompletionLegacyLOD.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentMain" runat="Server">
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <label for="FormalSelect">
                                    Formal:</label>
                                <asp:DropDownList ID="FormalSelect" AutoPostBack="True" runat="server">
        ...
        <asp:UpdatePanel ID="resultsUpdatePanel" runat="server" ChildrenAsTriggers="True">
            <ContentTemplate>
                ...
                <asp:GridView ID="gvResults" runat="server" AutoGenerateColumns="False" PageSize="10"
                    Width="100%" DataSourceID="LodData" AllowPaging="True" AllowSorting="True">
                    <Columns>
    ...
    <asp:ObjectDataSource ID="LodData" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetPostCompletion" TypeName="ALOD.Data.Services.LodService">
        <SelectParameters>
            <asp:ControlParameter ControlID="CaseIdbox" Name="caseID" PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="CheckBoxSearchAllCases" Name="searchAllCases" PropertyName="Checked"
                Type="Boolean" />
            ...
            <asp:Parameter Name="WsId"  Type="Int32" />
        </SelectParameters>
