<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false"
    Async="true" Inherits="ALOD.Web.LOD.Secure_lod_MyLods" Codebehind="MyLods.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentMain" runat="Server">
    ...
    <asp:UpdatePanel ID="resultsUpdatePanel_LODV3" runat="server" ChildrenAsTriggers="True">
        <ContentTemplate>
            <div id="spSpacer_LODV3" class="emptyItem" style="margin-top: 0px; margin-bottom: 4px;
                height: 22px;">
                <div id="spWait_LODV3" class="" style="display: none;">
                    &nbsp;<asp:Image runat="server" ID="Image1" SkinID="imgBusy" AlternateText="busy"
                        ImageAlign="AbsMiddle" />&nbsp;Loading...
                </div>
            </div>
            <asp:GridView ID="gvResults_LODV3" runat="server" EmptyDataText="No records found" EmptyDataRowStyle-CssClass="emptyItem"
                AutoGenerateColumns="False" PageSize="20" Width="100%" DataSourceID="LodData_LODV3"
                AllowPaging="True" AllowSorting="True">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
    ...
    <asp:ObjectDataSource ID="LodData_LODV3"  runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetByUserLODV3" TypeName="ALOD.Data.Services.LodService">
        <SelectParameters>
            <asp:ControlParameter ControlID="CaseIdbox" Name="caseID" PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="SsnBox" Name="ssn" PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="NameBox" Name="name" PropertyName="Text" Type="String" />
    ...
    <asp:UpdatePanel ID="resultsUpdatePanel_IO" runat="server" ChildrenAsTriggers="True" UpdateMode="Always">
        <ContentTemplate>
            <div id="spSpacer_IO" class="emptyItem" style="margin-top: 0px; margin-bottom: 4px;
                height: 22px;">
                <div id="spWait_IO" class="" style="display: none;">
                    &nbsp;<asp:Image runat="server" ID="Image2" SkinID="imgBusy" AlternateText="busy"
                        ImageAlign="AbsMiddle" />&nbsp;Loading...
                </div>
            </div>
            <asp:GridView ID="gvResults_IO" runat="server" EmptyDataText="No records found" EmptyDataRowStyle-CssClass="emptyItem"
                AutoGenerateColumns="False" PageSize="20" Width="100%" DataSourceID="LodData_IO"
                AllowPaging="True" AllowSorting="True">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
    ...
    <asp:ObjectDataSource ID="LodData_IO"  runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetByUserLOD_IO" TypeName="ALOD.Data.Services.LodService">
        <SelectParameters>
            <asp:ControlParameter ControlID="CaseIdbox" Name="caseID" PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="SsnBox" Name="ssn" PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="NameBox" Name="name" PropertyName="Text" Type="String" />
    ...
    <ajax:UpdatePanelAnimationExtender ID="resultsUpdatePanel_LODV3_AnimationExtender" runat="server"
        TargetControlID="resultsUpdatePanel_LODV3">
        <Animations>
                <OnUpdating>
                    <ScriptAction script="searchStart();" />
                </OnUpdating>  
    ...
    <ajax:UpdatePanelAnimationExtender ID="resultsUpdatePanel_IO_AnimationExtender" runat="server"
        TargetControlID="resultsUpdatePanel_IO" AlwaysFinishOnUpdatingAnimation="true">
        <Animations>
                <OnUpdating>
                    <ScriptAction script="searchStart();" />
                </OnUpdating>  
