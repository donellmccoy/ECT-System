<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Secure/Secure.master" CodeBehind="MyLodAudit.aspx.vb" Inherits="ALOD.Web.LOD.Secure_lod_MyLodAudit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentMain" runat="Server">
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="gvResults" runat="server" EmptyDataText="No records found" EmptyDataRowStyle-CssClass="emptyItem"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="CompletionDate" HeaderText="Date Notified" SortExpression="CompletionDate" />
                    <asp:BoundField DataField="Days" HeaderText="Days" SortExpression="Days" />
                    <asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description" />
                    <%--<asp:BoundField DataField="PassPriority" HeaderText="Pass Priority" SortExpression="Pass Priority" />--%>
    ...
    <asp:ObjectDataSource ID="LodData"  runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="0" Name="wsId" Type="Int16" />
