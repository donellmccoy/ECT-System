<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/lod/Lod.master" AutoEventWireup="false" Inherits="ALOD.Web.LOD.Secure_lod_NextAction" MaintainScrollPositionOnPostback="true" Codebehind="NextAction.aspx.vb" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterNested" runat="server">
    ...
    <script type="text/javascript">
        ...
        //used to save final form 348/261 to database
        function saveForm(id, final, form) {

            var url = $_HOSTNAME + "/Secure/lod/print.aspx?id=" + id + "&final=" + final + "&form=" + form;
            showPopup({
                'Url': url,
                'Width': '690',
                'Height': '700',
