<%@ Page Title="" Language="VB" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false"
    Async="true" Inherits="ALOD.Web.Special_Case.MEB.Secure_mb_MyCases" Codebehind="MyCases.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentMain" runat="Server">
    ...
    <asp:UpdatePanel ID="resultsUpdatePanel" runat="server" ChildrenAsTriggers="True">
        <ContentTemplate>
            ...
            <div style="font-weight:bold">My Cases: <%= WorkflowDao.GetCaseType(11, 0)%></div>
            ...
            <div style="font-weight: bold">
                My Cases: <%= WorkflowDao.GetCaseType(11, 0)%> - Waiting on Disposition Response
            </div>
            ...
            <asp:GridView ID="gvDisposition" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Special Case Type" SortExpression="ModuleId">
                        <ItemTemplate>
                            <asp:Label ID="Label2" runat="server" Text='<%#Eval("workflow_title")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="Days" HeaderText="Days" SortExpression="Days" />
                    <asp:BoundField DataField="PriorityRank" HeaderText="Priority" SortExpression="PriorityRank" />
            ...
            <div style="font-weight: bold">
                My Cases: <%= WorkflowDao.GetCaseType(11, 0)%> - Holding
            </div>
    ...
    <asp:ObjectDataSource ID="SCData_Module11"  runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            <asp:Parameter Name="moduleId" Type="Int32" DefaultValue="11" />
            <asp:SessionParameter Name="userId" SessionField="UserId" Type="Int32" />
            <%--<asp:Parameter Name="statusId" Type="Int32" DefaultValue="95" />--%>
        </SelectParameters>    
