...
Namespace Web.Special_Case.MEB
    ...
    Partial Class Secure_sc_meb_NextAction
        ...
        Private boardStages As Short() = New Short() {
            CShort(SpecCaseMEBStatusCode.InitiateCase),
            CShort(SpecCaseMEBStatusCode.MedicalReview),
            CShort(SpecCaseMEBStatusCode.SeniorMedicalReview),
            CShort(SpecCaseMEBStatusCode.FinalReview),
            CShort(SpecCaseMEBStatusCode.AwaitingAFPC),
            CShort(SpecCaseMEBStatusCode.MedicalReviewAFPC),
            CShort(SpecCaseMEBStatusCode.SeniorMedicalReviewAFPC),
            CShort(SpecCaseMEBStatusCode.FinalReviewAFPC),
            CShort(SpecCaseMEBStatusCode.IPEBDisposition),
            CShort(SpecCaseMEBStatusCode.FPEBDisposition),
            CShort(SpecCaseMEBStatusCode.TransitionPhase),
            CShort(SpecCaseMEBStatusCode.MedicalReviewIPEB),
            CShort(SpecCaseMEBStatusCode.SeniorMedicalReviewIPEB),
            CShort(SpecCaseMEBStatusCode.FinalReviewIPEB),
            CShort(SpecCaseMEBStatusCode.MedicalReviewFPEB),
            CShort(SpecCaseMEBStatusCode.SeniorMedicalReviewFPEB),
            CShort(SpecCaseMEBStatusCode.FinalReviewFPEB),
            CShort(SpecCaseMEBStatusCode.MedicalReviewTransitionPhase),
            CShort(SpecCaseMEBStatusCode.SeniorMedicalReviewTransitionPhase),
            CShort(SpecCaseMEBStatusCode.FinalReviewTransitionPhase)}

        Private CANCELLATION_REASON As String = "Case Cancelled By "
        Private errors As New List(Of ValidationItem)
        Private sc As SC_MEB
        Private separatorTemplate As System.Web.UI.CompiledTemplateBuilder

        Private unitStages As Short() = New Short() {
            CShort(SpecCaseMEBStatusCode.RWOAAction),
            CShort(SpecCaseMEBStatusCode.MedTechInput)}

#Region "SC_MEBProperty"
...
#End Region
        ...
        Protected Function GetStatusInfo(ByVal statusCodeOut As Integer) As Tuple(Of Integer, String)
            ...
            Select Case statusCodeOut
                Case SpecCaseMEBStatusCode.InitiateCase, SpecCaseMEBStatusCode.RWOAAction, SpecCaseMEBStatusCode.FinalReview, SpecCaseMEBStatusCode.AwaitingAFPC,
                     SpecCaseMEBStatusCode.FinalReviewAFPC, SpecCaseMEBStatusCode.IPEBDisposition, SpecCaseMEBStatusCode.FPEBDisposition, SpecCaseMEBStatusCode.TransitionPhase,
                     SpecCaseMEBStatusCode.FinalReviewIPEB, SpecCaseMEBStatusCode.FinalReviewFPEB, SpecCaseMEBStatusCode.FinalReviewTransitionPhase
                    sentTo = "HQ Tech"
                    sentToId = UserGroups.AFRCHQTechnician
                Case SpecCaseMEBStatusCode.MedicalReview, SpecCaseMEBStatusCode.MedicalReviewAFPC, SpecCaseMEBStatusCode.MedicalReviewIPEB,
                     SpecCaseMEBStatusCode.MedicalReviewFPEB, SpecCaseMEBStatusCode.MedicalReviewTransitionPhase
                    sentTo = "Board Medical"
                    sentToId = UserGroups.BoardMedical
                Case SpecCaseMEBStatusCode.SeniorMedicalReview, SpecCaseMEBStatusCode.SeniorMedicalReviewAFPC, SpecCaseMEBStatusCode.SeniorMedicalReviewIPEB,
                     SpecCaseMEBStatusCode.SeniorMedicalReviewFPEB, SpecCaseMEBStatusCode.SeniorMedicalReviewTransitionPhase
        ...
        Private Sub ShowRLB()
            Dim access As ALOD.Core.Domain.Workflow.PageAccessType = SectionList(MBSectionNames.MB_RLB.ToString())
...
#Region "ChangeStatusAndActions"
        ...
        Public Sub AddEmails(ByRef emails As MailManager, emailService As EmailService, action As WorkflowOptionAction, statusOut As Integer)
            ...
            If (statusOut = SpecCaseMEBWorkStatus.RTD Or statusOut = SpecCaseMEBWorkStatus.Disqualified Or statusOut = SpecCaseMEBWorkStatus.AwaitingAFPC) Then
        ...
        Public Sub ReturnBack(ByVal statusIn As Integer, ByVal statusOut As Integer, ByVal ReturnFlag As Boolean)
            ...
            If (rwRec IsNot Nothing AndAlso rwRec.DateSentBack Is Nothing) Then
                ...
                ElseIf (statusCodeOut = SpecCaseMEBStatusCode.Cancelled) Then           'Case was canceled during Return
                    rwRec.DateSentBack = DateTime.Now
                ...
                ElseIf (statusCodeOut = SpecCaseMEBStatusCode.Disqualified OrElse statusCodeOut = SpecCaseMEBStatusCode.RTD) Then            'Case was completed during Return
                    rwRec.DateSentBack = DateTime.Now
                    If (String.IsNullOrEmpty(rwRec.CommentsBackToSender)) Then
