...
namespace ALOD.Tests.Unit.Data
{
    ...
    {
        private readonly Mock<IUserRoleDao> _mockDao;

        public UserRoleDaoTests()
        {
            _mockDao = new Mock<IUserRoleDao>();
        }
        ...
        public void Save_WithValidEntity_ReturnsSavedEntity()
        {
            ...
            _mockDao.Setup(x => x.Save(It.IsAny<UserRole>())).Returns(entity);
            ...
            _mockDao.Verify(x => x.Save(It.IsAny<UserRole>()), Times.Once);
        }
        ...
        [InlineData(50)]
        [InlineData(500)]
        public void GetById_WithVariousIds_ReturnsUserRole(int id)
        {
            // Arrange
            _mockDao.Setup(x => x.GetById(id)).Returns(new UserRole());
        ...
        public void GetAll_ReturnsAllEntities()
        {
            ...
            _mockDao.Setup(x => x.GetAll()).Returns(roles);
        ...
        public void Delete_WithValidEntity_CallsDelete()
        {
            // Arrange
            var entity = new UserRole();
            _mockDao.Setup(x => x.Delete(It.IsAny<UserRole>()));

            // Act
            _mockDao.Object.Delete(entity);

            // Assert
            _mockDao.Verify(x => x.Delete(It.IsAny<UserRole>()), Times.Once);
        }
        ...
        public void SaveOrUpdate_WithValidEntity_ReturnsSavedEntity()
        {
            // Arrange
            var entity = new UserRole();
            _mockDao.Setup(x => x.SaveOrUpdate(It.IsAny<UserRole>())).Returns(entity);
            ...
            // Assert
            Assert.NotNull(result);
            _mockDao.Verify(x => x.SaveOrUpdate(It.IsAny<UserRole>()), Times.Once);
        }
