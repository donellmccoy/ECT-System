<%@ Page Language="C#" MasterPageFile="~/Public/Public.master" AutoEventWireup="false" Inherits="ALOD.Web.Public_Register4" Title="ECT Registration" CodeBehind="Register4.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentMain" runat="Server">
    <div id="content">
        <h1>
            ECT Registration > Registration Complete</h1>
