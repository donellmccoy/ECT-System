<%@ Page Language="C#" MasterPageFile="~/Secure/Lod/LOD.master" AutoEventWireup="false" EnableViewState="True" EnableEventValidation="false" Inherits="ALOD.Web.LOD.Secure_lod_c2_Medical" Title="Untitled Page" CodeBehind="Medical.aspx.cs" MaintainScrollPositionOnPostback="true" %>
    ...
    <asp:Panel runat="server" ID="OriginalLOD" CssClass="dataBlock" Visible="false">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="label labelRequired">
                    *Name and Location of initial treating facility:
                </td>
                <td class="value">
            ...
            <tr>
                ...
                <td class="label labelRequired">
                    *Date and Time of Initial Treatment:
                </td>
                <td class="value">
            ...
            <tr>
                ...
                <td class="label">
                    Does this case involve a Motor Vehicle Accident (MVA):
                </td>
                <td class="value">
