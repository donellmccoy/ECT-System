<%@ Page Language="C#" MasterPageFile="~/Secure/Lod/LOD.master" AutoEventWireup="false" Inherits="ALOD.Web.LOD.Secure_lod_c2_Unit" Title="Untitled Page" CodeBehind="Unit.aspx.cs" MaintainScrollPositionOnPostback="true"%>
            ...
            <table class="dataTable">
                ...
                <tr>
                    ...
                    <td class="label">
                        ...
                        <br /><br />
                        <span class="labelRequired">*Was the member on orders of 31 days or more:</span>
                    </td>
                    <td>
