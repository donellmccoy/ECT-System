<%@ Page Title="" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false"
    Async="true" Inherits="ALOD.Web.Special_Case.BMT.Secure_bm_MyCases" CodeBehind="MyCases.aspx.cs" %>
    ...
    <asp:UpdatePanel ID="resultsUpdatePanel" runat="server" ChildrenAsTriggers="True">
        <ContentTemplate>
            ...
            <div style="font-weight: bold" >
                My Cases:
                <%= WorkflowDao.GetCaseType(8, 1) %> / <%= WorkflowDao.GetCaseType(8, 2) %>
            </div>
            ...
            <br />
             ...
             <div style="font-weight: bold">
                My Cases: <%= WorkflowDao.GetCaseType(8, 0) %> - Waiting on Disposition Response
            </div>
            ...
            <div style="font-weight: bold">
                My Cases: <%= WorkflowDao.GetCaseType(8, 1)%> - Holding
            </div>
