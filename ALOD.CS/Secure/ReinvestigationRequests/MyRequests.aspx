<%@ Page Title="" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="false"
    Async="true" Inherits="ALOD.Web.RR.Secure_rr_MyRequests" CodeBehind="MyRequests.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentMain" runat="Server">
    ...
    <asp:UpdatePanel ID="resultsUpdatePanel" runat="server" ChildrenAsTriggers="True">
        <ContentTemplate>
            ...
            <div style="font-weight:bold">My Reinvestigation Requests:</div>
            <asp:GridView ID="gvResults" runat="server" EmptyDataText="No records found" EmptyDataRowStyle-CssClass="emptyItem"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Case Id" SortExpression="Case_Id" ItemStyle-Width="150px">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkRefID" runat="server" CommandArgument='<%# Eval("Request_Id").ToString()  %>'
            ...
            <asp:GridView ID="gvResults2" runat="server" EmptyDataText="No records found" EmptyDataRowStyle-CssClass="emptyItem"
                AutoGenerateColumns="False" PageSize="20" Width="100%" DataSourceID="LodData2"
                AllowPaging="True" AllowSorting="True">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
    ...
    <asp:ObjectDataSource ID="LodData"  runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetReinvestigationRequests" TypeName="ALOD.Data.Services.LodService">
        <SelectParameters>
            <asp:SessionParameter Name="userId" SessionField="UserId" Type="Int32" />
            <asp:SessionParameter Name="sarc" SessionField="sarc" Type="Byte" />
        </SelectParameters>
    </asp:ObjectDataSource>
    <asp:ObjectDataSource ID="LodData2"  runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetCompletedRRs" TypeName="ALOD.Data.Services.LodService">
        <SelectParameters>
            <asp:SessionParameter Name="userId" SessionField="UserId" Type="Int32" />
            <asp:SessionParameter Name="sarc" SessionField="sarc" Type="Byte" />
        </SelectParameters>
