<%@ Page Title="" Language="C#" MasterPageFile="~/Secure/SC_BCMR/SC_BCMR.master" AutoEventWireup="false" Inherits="ALOD.Web.Special_Case.BCMR.Secure_sc_bc_NextAction" MaintainScrollPositionOnPostback="true" CodeBehind="NextAction.aspx.cs" %>
