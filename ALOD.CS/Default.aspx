<%@ Page Title="" Language="C#" MasterPageFile="~/Public/Public.master" AutoEventWireup="true"
    Inherits="ALOD.Web._Default" CodeBehind="Default.aspx.cs" %>
    ...
    <asp:Content ID="Content1" ContentPlaceHolderID="ContentMain" runat="Server">
        ...
        <div id="front-actions">
            <div
                style="float: left; width: 600px; height: 275px; background-repeat: no-repeat; background-color: transparent; ">
                <img style="width: 600px; height: 275px" src="App_Themes/DefaultBlue/images/ALOD1.jpg" id="banner"
                    alt="ECT Banner" />
            </div>
                        ...
                        <td style="text-align:center;">
                            ...
                            <div>
                                <asp:HyperLink ID="WhatIsEct" runat="server" NavigateUrl="~/Public/About.aspx"
                                    Text="<%$ Resources:Global, LODFAQLink %>" Target="_blank" Font-Bold="True">
                                </asp:HyperLink><br />
                            </div>
                        </td>
                    </tr>
        ...
        <div id="frontpage-content">
            ...
            <p class="disclaimer">
                <asp:Label runat="server" ID="SiteDisclaimer" Text="<%$ Resources:Global, SiteDisclaimer %>">
                </asp:Label>
            </p>
        </div>
